    ...
    <div class="container">
        <div class="row">
            ...
            <!-- 
					...
					3. 상품평 기능 구현 *
					4. 업데이트 기능 구현 *
					5. 목록버튼 처리가 완료되었습니다 모달 안뜨게 하기 -> 페이징 처리에서 같이 처리? result 부분을 이용하기 ex) success면 처리 완료, list면 x 라던지
					6. 카테고리 항목 데이터값을 반영하기 *
            ...
            <div class="col-sm-9 padding-right">
                <div class="product-information">
                    <!--/product-information-->
                    <form id='updateForm' action="/petshop/update" method="post">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('button').on("click", function(e) {
            ...
            if(operation === 'delete') {
                updateForm.attr("action", "/petshop/delete");
            } else if(operation === 'list') {
                updateForm.attr("action", "/petshop/list").attr("method", "get");
